  ...
  public: {
    Tables: {
      course_places: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_places_course_id_courses_id_fk"
            columns: ["course_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "course_places_place_id_places_id_fk"
            columns: ["place_id"]
            isOneToOne: false
      ...
      courses: {
        ...
        Relationships: [
          {
            foreignKeyName: "courses_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
